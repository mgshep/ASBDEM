...
GRANT SELECT
    ON OBJECT::[core].[sqlserverProperties] TO [PowerShellUser]
    AS [dbo];
GO
...
ALTER TABLE [core].[sqlserverProperties]
    ADD CONSTRAINT [FK_sqlserverProperties_servers] FOREIGN KEY ([serverid]) REFERENCES [core].[servers] ([serverid]) ON DELETE CASCADE ON UPDATE CASCADE;
GO
