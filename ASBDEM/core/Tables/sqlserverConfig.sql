...
ALTER TABLE [core].[sqlserverConfig]
    ADD CONSTRAINT [FK_sqlserverConfig_servers] FOREIGN KEY ([serverid]) REFERENCES [core].[servers] ([serverid]) ON DELETE CASCADE ON UPDATE CASCADE;
GO

GRANT SELECT
    ON OBJECT::[core].[sqlserverConfig] TO [PowerShellUser]
    AS [dbo];
GO
