CREATE TABLE [core].[servers] (
    ...
    CONSTRAINT [CK_servers_environment] CHECK ([environment]='Prod' OR [environment]='FST' OR [environment]='QA' OR [environment]='Dev'),
    CONSTRAINT [FK_servers_servertype] FOREIGN KEY ([servertypeid]) REFERENCES [core].[servertype] ([servertypeid])
);
